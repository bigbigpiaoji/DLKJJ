  ...
  methods: {
    ...
    onChangeEpidemic(val) {
      if (val === "back") {
        ...
        this.showback = false; //是否显示返回按钮
        this.maxDataIndustry = this.backMaxDataIndustry; //背景柱子数量
      }
    },
  },
};
