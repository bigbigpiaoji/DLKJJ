      ...
      <div class="main-tree-branch-wrap">
        ...
        <div class="main-tree-branch right-bottom">
          <bubble v-bind="bubbleRightBottom"
                  :style="setStyle(bubbleRightBottom)"
                  @click="onBubbleClick"></bubble>
...
export default {
      ...
      asideLeft: [
        {
          ...
          value: '243',
          unit: 'T',
          icon: `${CONFIG.imgUrl}/count-info/icon-zsjl.png`,
        },
        {
          name: '结构化数据',
          value: '147',
          unit: 'T',
          icon: `${CONFIG.imgUrl}/count-info/icon-jghsj.png`,
        },
        {
          name: '非结构化数据',
          value: '89',
          unit: 'T',
          icon: `${CONFIG.imgUrl}/count-info/icon-fjghsj.png`,
        },
      ],
      asideRight: [
        {
          ...
          value: '861',
          unit: '亿',
          icon: `${CONFIG.imgUrl}/count-info/icon-sjts.png`,
        },
        {
          name: '数据表',
          value: '6091',
          unit: '张',
          icon: `${CONFIG.imgUrl}/count-info/icon-sjb.png`,
        },
        {
          name: '支撑应用',
          value: '63',
          unit: '个',
          icon: `${CONFIG.imgUrl}/count-info/icon-zcyy.png`,
        },
      ],
      nav: [
        {
          name: '政务数据',
          icon: `${CONFIG.imgUrl}/light-nav/icon-zwsj.png`,
          type: 'near',
        },
        {
          name: '营销客服',
          icon: `${CONFIG.imgUrl}/light-nav/icon-yxkf.png`,
          type: 'far',
        },
        {
          name: '电网运行',
          icon: `${CONFIG.imgUrl}/light-nav/icon-dwyx.png`,
          type: 'near',
        },
        {
          name: '电力物联网',
          icon: `${CONFIG.imgUrl}/light-nav/icon-dlwlw.png`,
          type: 'near',
        },
        {
          name: '其他',
          icon: `${CONFIG.imgUrl}/light-nav/icon-qt.png`,
          type: 'far',
        },
        {
          name: '电网管理',
          icon: `${CONFIG.imgUrl}/light-nav/icon-dwgl.png`,
          type: 'near',
        },
      ],
      bubbleLeft: {
  ...
  methods: {
    setStyle(item) {
      return {
        left: `${this.$pxToRem(item.left)}rem`,
        top: `${this.$pxToRem(item.top)}rem`,
      }
    },
    ...
    onBubbleClick(name) {
      if (name === '双碳大脑') {
        window.open('http://10.150.37.240:9999/stdn', '_blank')
      } else if (name === '电力看经济') {
        window.open('http://10.150.45.233:8888/index.html#/report', '_blank')
      }
    },
  },
}
